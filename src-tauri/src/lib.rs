...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![direct::host_room, direct::set_manual_endpoint, direct::join_room, direct::send_chat, direct::drain_events, direct::stop_room])
